...
def add():
    ...
    cursor.execute("INSERT INTO PRODUCE (TYPE,NAME)\
        VALUES (?,?)",(choice,item));  
    conn.commit()
...
cursor.execute('''CREATE TABLE IF NOT EXISTS PRODUCE (ID INTEGER PRIMARY KEY AUTOINCREMENT,TYPE STRING NOT NULL,NAME STRING NOT NULL);''')
